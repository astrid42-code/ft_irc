...
/*   Updated: 2022/10/01 14:09:02 by asgaulti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void invite(Cmd &command)
{
    ...
    else if (!command._server->get_user(command.get_value()[0])) // ou?? : command.get_value()[0] != command._user->get_nick()) // a revoir > pas la bonne comparaison
